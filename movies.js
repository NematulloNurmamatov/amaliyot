...
// movies.forEach((item)=>{
//   if (item.item_count > 500 && item.item_count < 1200) {
...
// let movie = movies[6].name.replace(fantastic)

movies[6].name = 'fantastik'


//   let news = [];

// movies.forEach((movie) => {
//   // console.log(`Title: ${movie.name}, Description: ${movie.description}, Favorite Count: ${movie.favorite_count}`);
//   // console.log("-----------------------------------------");
//   // console.log("");
//   // console.log(`${movie.name}`);
//   // console.log(movie.description);
  
//   if (movie.iso_639_1 == "en") {
//     news.push(movie);
//     console.log(`${movie.iso_639_1}`);
